...
function OpenVehicleSpawnerMenu(type, station, part, partNum)
	...
	ESX.UI.Menu.Open('default', GetCurrentResourceName(), 'vehicle', {
		...
		if data.current.action == 'buy_vehicle' then
			...
			local authorizedVehicles = Config.AuthorizedVehicles.Shared--[type][ESX.PlayerData.job.grade_name]
...
function GetAvailableVehicleSpawnPoints(station, part, partNum)
